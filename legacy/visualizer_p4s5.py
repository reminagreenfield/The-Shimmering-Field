"""
The Shimmering Field — Phase 4 Step 5 Live Visualizer
======================================================
Runs the simulation and renders it in real-time using Pygame.
Phase 4 capstone: collapse dynamics, fungal networks, capacity shedding.

Usage:
    pip install pygame numpy scipy
    python visualizer_p4s5.py

Place this file in the same directory as phase4_step5.py.
...
Controls:
    ...
    8          — Toggle fungal network overlay       (NEW)
    9          — Toggle ecosystem integrity overlay   (NEW)
...
def draw_stats_panel(surface, world, x_offset, color_mode, steps_per_frame,
    ...
    lines.append(("Phase 4 Step 5: Fungal Networks", (140, 130, 170)))
    lines.append(("", None))
    ...
    cm_names = {
        ...
        "endosymbiosis": "Endosymbiosis", "shedding": "Capacity Shedding",
        "cascade": "Genomic Cascade", "development": "Development", "age": "Age",
    }
...
def main():
    pygame.init()
    pygame.display.set_caption("The Shimmering Field \u2014 Phase 4 Step 5: Fungal Networks")
